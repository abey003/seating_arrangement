...
#2nd Round Sorting
    ...
    for i in range(j,len(element_1),1):
        extracted_data_1 = element_1[i]
        while(a<len(element_2)):     # When a is over, it will only map seating for 1st data
            extracted_data_2 = element_2[a]
            data.append(extracted_data_1[0])
            data.append(extracted_data_2[0])
            a = a+1
...
#2nd Round Sorting
    ...
    for i in range(j,len(element_1),1):
        ...
        data.append(extracted_data_1[0])
        data.append(extracted_data_2[0])
        k = k+1     # k is used as index for 3rd Round
        a = a+1
...
#3rd Round Sorting
    ...
    for i in range(k,len(element_1),1):
        ...
        data.append(extracted_data_1[0])
        data.append(extracted_data_2[0])
        j = j+1     # j is used as index for 4th Round
        a = a+1
